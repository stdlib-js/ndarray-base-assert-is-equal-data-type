...
```javascript
import isEqualDataType from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-assert-is-equal-data-type@v0.1.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/ndarray-base-assert-is-equal-data-type/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/ndarray-base-assert-is-equal-data-type/actions/workflows/test.yml?query=branch:v0.1.1
